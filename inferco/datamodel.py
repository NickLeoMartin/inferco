...
class DataSource(SQLModel, table=True):
    ...
    type: DataSourceType = Field(
        default=DataSourceType.postgres, sa_column=Column(SqlEnum(DataSourceType))
    )
    user_id: Optional[str] = None
    
    # TODO: add field validation for SQL params...
    ...
    additional_params: Optional[Dict] = Field(default=None, sa_column=Column(JSON))
