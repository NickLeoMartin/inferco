...
def ui(
    ...
    Args:
        ...
        database-uri (str, optional): Database URI to connect to. Defaults to None. Examples include sqlite:///inferco.db, postgresql://user:password@localhost/inferco.
    """

    os.environ["inferco_API_DOCS"] = str(docs)
    if appdir:
        os.environ["inferco_APPDIR"] = appdir
    if database_uri:
        os.environ["inferco_DATABASE_URI"] = database_uri
